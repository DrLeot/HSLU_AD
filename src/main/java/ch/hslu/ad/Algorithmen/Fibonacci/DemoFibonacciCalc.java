 ...
 */
package ch.hslu.ad.Algorithmen.Fibonacci;
...
public final class DemoFibonacciCalc {
    ...
    public static void main(final String[] args) {
        ...
        LOG.info("Conc. recursive : {} sec.", (float)(System.currentTimeMillis()-startTime)/1000);

        startTime = System.currentTimeMillis();
        result = fiboIterative(n);
        LOG.info("Func. iterative = {}", result);
        LOG.info("Func. iterative : {} sec.", (float)(System.currentTimeMillis()-startTime)/1000);

        startTime = System.currentTimeMillis();
        result = fiboRecursive(n);
        LOG.info("Func. recursive = {}", result);
        LOG.info("Func. recursive : {} sec.", (float)(System.currentTimeMillis()-startTime)/1000);
